...
class PaintGUI:
    ...
    def __init__(self):
        ...
        self.root = Tk()
        self.root.title("Pynt")

        self.brush_width = 15
        self.current_color = "#000000"

        self.canvas = Canvas(self.root, width=constants.WIDTH-10, height=constants.HEIGHT-10, bg="white")
        self.canvas.pack()
        self.canvas.bind("<B1-Motion>", self.paint)

        self.image = PIL.Image.new("RGB", (constants.WIDTH, constants.HEIGHT), constants.WHITE)
    ...
    def paint(self, event):
        ...
        self.canvas.create_rectangle(x1, y1, x2, y2, outline=self.current_color, fill=self.current_color,
